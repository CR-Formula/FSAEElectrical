...
typedef struct data_struct {
  ...
  uint32_t Lng;        // Longitude
  uint32_t Speed;      // GPS Speed
  ...
  uint32_t BrakeBias;  // Brake Bias
  uint32_t AccX;       // Accelerometer X Axis
  uint32_t AccY;       // Accelerometer Y Axis
  uint32_t AccZ;       // Accelerometer Z Axis
  uint32_t GyrX;       // Gyroscope X Axis
  uint32_t GyrY;       // Gyroscope Y Axis
  uint32_t GyrZ;       // Gyroscope Z Axis
  uint32_t MagX;       // Magnetometer X Axis
  uint32_t MagY;       // Magnetometer Y Axis
  uint32_t MagZ;       // Magnetometer Z Axis
} data_struct;
