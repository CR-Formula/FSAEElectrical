...
//	public static float[] neutralColor            = new float[] {43f/255f, 41f/255f, 46f/255f, 1.0f}; // Dark Mode
	public static float[] neutralColor            = new float[] {31f/255f, 30f/255f, 32f/255f, 1.0f}; // Dark Mode V2
